...
const string strMessageMagic = "Slate Signed Message:\n";
...
static const int64_t nTargetTimespan = 5 * 30;  // 5 blocks
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Slate", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The most secure coin in the market";
        CTransaction txNew;
        txNew.nTime = 1405870317;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1405870317;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 143725;
		if(fTestNet)
        {
            block.nNonce   = 1482878;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x4bfcfbed4526f3be6e21ca0dbe0f8040980bac81065c9bd34822f51273436fc9"));
        block.print();
